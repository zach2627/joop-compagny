...
> = {
  fr: {
    ...
    categoryNarratives: {
      ...
      coffrets:
        "Des compositions pr̻tes a offrir, pensees comme des cadeaux signature.",
    },
  },
  en: {
      ...
      <main className="pt-[100px]">
        ...
        <section
          ...
          style={{
            ...
            background:
              "linear-gradient(180deg, #0A0A08 0%, #0A0A08 48%, #111109 100%)",
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(10,10,8,0.4) 0%, rgba(10,10,8,0.18) 18%, rgba(10,10,8,0.72) 68%, rgba(10,10,8,0.96) 100%), radial-gradient(circle at 18% 22%, rgba(201,168,76,0.12), transparent 24%), radial-gradient(circle at 88% 16%, rgba(255,255,255,0.08), transparent 16%)",
            }}
          />
          <div
            ...
            <div className="grid flex-1 items-end gap-10 lg:grid-cols-[minmax(0,1.15fr)_360px] lg:gap-14">
              ...
              <ScrollReveal delay={120}>
                <aside
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(10,10,8,0.72) 0%, rgba(10,10,8,0.9) 100%)",
                        ...
                        >
                          ...
                          >
                            <ProductImageFallback
                              src={
                                primaryImage ? productCardImage(primaryImage.url) : undefined
                              }
          ...
          <div className="container-xl">
            <ScrollReveal>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #111109 0%, #1A1A14 100%)",
                  ...
                  >
                    <div className="relative aspect-[0.9] overflow-hidden rounded-[24px]">
                      <ProductImageFallback
                        ...
                        label={translateProductContent(locale, coffretShowcase).name}
                        fill
              ...
              <div className="mb-8 md:mb-10">
                ...
                <div className="mt-4 grid gap-4 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-end">
                  ...
                  <p
                    ...
                    style={{ color: "rgba(255,255,255,0.6)", lineHeight: 1.9 }}
                  >
                    {copy.worldsLead}
                  </p>
                </div>
                ...
                return (
                  <ScrollReveal key={slug} delay={index * 90}>
                    <Link
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, #111109 0%, #1A1A14 100%)",
                        border: "1px solid rgba(201,168,76,0.12)",
                      }}
                    >
                      {imageUrl ? (
                        <>
                          ...
                          <div
                            ...
                            style={{
                              background:
                                "linear-gradient(180deg, rgba(10,10,8,0.08) 0%, rgba(10,10,8,0.34) 32%, rgba(10,10,8,0.86) 100%)",
                            }}
                          />
                        </>
                      ) : null}
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_420px]">
              ...
              <ScrollReveal delay={120}>
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(160deg, rgba(201,168,76,0.14) 0%, #111109 38%, #1A1A14 100%)",
